<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.Master" AutoEventWireup="true" CodeBehind="DummyStudent.aspx.cs" Inherits="SchoolManagementSystem.Tables.DummyStudent" %>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="form-control btn btn-primary" OnClick="btnSave_Click1"  />
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group ">
                                <asp:GridView ID="gvStudentRegistration" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-striped" OnRowCommand="gvStudentRegistration_RowCommand" >
                                    <Columns>
